...
//                             libreria de C++ que permite plotear una imagen PNG
...
/* Nota - Este programa esta en ingles. Para entender cabalmente lo que hace,
 * sugiero que aprendas cosas basicas acerca del caos y los fractales, luego sobre
 * la ecuacion logistica y luego los exponentes de lyapunov. Un website que quizas
 * sea de ayuda es uno que hice yo:
 * http://ket.dyndns.org/eclog/
 * */
